  ...
  return (
    ...
    <div class="container">
        <div class="info">
            ...
            <div class="date-time">
                <time class="time">00:00 AM</time> -
                <time class="date"> 00 Jan 0000</time>
            </div>
            <div class="next-prayer-time">
                <div class="time-till-next">
                    <time>00:00:00</time>
                    <div class="next-prayer">Untill <span>Fajr</span></div>
        ...
        <div class="prayers">
            <ul>
                <li class="prayer">
                    ...
                    <div class="prayer-time">00:00 AM</div>
                </li>
                <li class="prayer">
                    <div class="prayer-name">Shorouk</div>
                    <div class="prayer-time">00:00 AM</div>
                </li>
                <li class="prayer">
